...
if (isset($_GET['selesai'])) {
    ...
    if ($stmt->execute()) { header('Location: customers.php'); exit(); } 
                    ...
                    <tbody>
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row['status'] == 'Belum Selesai') {
                                    echo "<a href='customers.php?selesai=" . $row['id_customer'] . "' class='btn btn-success btn-sm' onclick='return confirm(\"Tandai Selesai?\")'>Selesai</a>";
                                } else {
                                    echo "<a href='customers.php?batalkan=" . $row['id_customer'] . "' class='btn btn-warning btn-sm' onclick='return confirm(\"Batalkan status?\")'>Batalkan</a>";
                                }
