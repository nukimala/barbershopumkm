<footer class="footer-area section-bg" data-background="assets/img/gallery/footer_bg.png">
  <div class="container">
    <div class="footer-flex" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; text-align:center; color:#ddd; padding:30px 0;">
      
      <!-- Logo kiri -->
      <div class="footer-logo" style="flex:1; text-align:left;">
        <a href="index.php"><img src="assets/img/logo/logo2_footer.png" alt="Logo" style="width:100px;"></a>
      </div>
